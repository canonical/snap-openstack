            ...
            extra_tfvars.update(
                {
                    ...
                    # TODO: Uncomment the following lines when cross-controller
                    # relation support gets added to the Terraform Juju provider:
                    #   https://github.com/juju/terraform-provider-juju/issues/805
...
class OpenStackPatchLoadBalancerServicesIPStep(PatchLoadBalancerServicesIPStep):
    ...
    def services(self):
        ...
        if self.client.cluster.list_nodes_by_role(
            "storage"
        ) and is_internal_ceph_enabled(self.client):

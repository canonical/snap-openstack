...
class HPEthreeparConfig(StorageBackendConfig):
    ...
    hpe3par_api_url: Annotated[
        str | None,
        Field(alias="hpe3par-api-url", description="HPE 3Par WSAPI url"),
    ] = None
    hpe3par_username: Annotated[
        str | None,
        Field(alias="hpe3par-username", description="HPE 3Par user with admin role"),
        SecretDictField(field="hpe3par-username"),
    ] = None
    hpe3par_password: Annotated[
        str | None,
        Field(
            alias="hpe3par-password",
    ...
    replication_device: Annotated[
        str | None,
        Field(
            """Specific replication configuration settings.
    ...
    hpe3par_debug: Annotated[
        bool | None,
        Field(
            alias="hpe3par-debug", description="HPE 3Par enable debug for WSAPI calls"
        ),
    ] = False
    hpe3par_snapshot_retention: Annotated[
        str | None,
        Field(
            alias="hpe3par-snapshot-retention",
    ...
    hpe3par_snapshot_expiration: Annotated[
        str | None,
        Field(
            alias="hpe3par-snapshot-expiration",
    ...
    hpe3par_iscsi_chap_enabled: Annotated[
        bool,
        Field(
            alias="hpe3par-iscsi-chap-enabled",
    ...
    reserved_percentage: Annotated[
        int | None,
        Field("This flag represents the percentage of reserved back_end capacity"),
    ] = None

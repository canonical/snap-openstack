...
class PowerFlexConfig(StorageBackendConfig):
    ...
    san_login: Annotated[
        str,
        Field(description="Username for PowerFlex Gateway with administrative privileges"),
    ...
    driver_ssl_cert: Annotated[
        str | None, Field(description="PEM-encoded SSL certificate to use for HTTPS connections")
    ] = None

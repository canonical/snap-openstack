...
Provides local Ceph storage via the microceph charm deployed to the
machine model on storage-role nodes. This is the default and currently
only implementation of CephProvider.
"""

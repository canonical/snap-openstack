...
class RemoveManilaDataUnitsStep(RemoveMachineUnitsStep):
    """Remove Manila Data Unit."""
    ...
    def __init__(
        ...
        super().__init__(
            ...
            APPLICATION,
            model,
            "Remove Manila Data unit(s)",
            "Removing Manila Data unit(s) from machine",
        )
...
class CheckManilaDataDistributionStep(BaseStep):
    ...
    def __init__(
        ...
        super().__init__(
            "Check Manila Data distribution",
            "Check if node is hosting units of Manila Data",
        )
        self.client = client
        self.node = name
